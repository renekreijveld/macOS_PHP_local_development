        ...
        <div class="accordion" id="toolsAccordion">
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading_system">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapse_system" aria-expanded="false"
                        aria-controls="collapse_system">
                        System monitor
                    </button>
                </h2>
                <div id="collapse_system" class="accordion-collapse collapse"
                    aria-labelledby="heading_system" data-bs-parent="#toolsAccordion">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading_nginx">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapse_nginx" aria-expanded="false"
                        aria-controls="collapse_nginx">
                        NginX
                    </button>
                </h2>
                <div id="collapse_nginx" class="accordion-collapse collapse"
                    aria-labelledby="heading_nginx" data-bs-parent="#toolsAccordion">
                    <div class="accordion-body">
                        ...
                        <ul>
                            <?php foreach ($websites as $website) : ?>
                                ...
                                <li><a href="https://<?php echo $website; ?>.dev.test" target="_blank"><?php echo $website; ?></a> (php <?php echo $phpVersion; ?>)</li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                </div>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading_cmdline">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapse_cmdline" aria-expanded="false"
                        aria-controls="collapse_cmdline">
                        Command line tools
                    </button>
                </h2>
                <div id="collapse_cmdline" class="accordion-collapse collapse"
                    aria-labelledby="heading_cmdline" data-bs-parent="#toolsAccordion">
                    <div class="accordion-body">
                        <table class="table">
                            <tr>
                                <td><pre><code><strong>addsite</strong></code></pre></td>
...
-h display this help.</code></pre>
                            ...
                            <tr>
                                <td><pre><code><strong>delsite</strong></code></pre></td>
...
-h display this help.</code></pre>
                            ...
                            <tr>
                                <td><pre><code><strong>adddb</strong></code></pre></td>
...
-h display this help.</code></pre>
                            ...
                            <tr>
                                <td><pre><code><strong>deldb</strong></code></pre></td>
...
-h display this help.</code></pre>
                            ...
                            <tr>
                                <td><pre><code><strong>setrights</strong></code></pre></td>
...
<pre><code>Usage: setrights</code></pre>
                            ...
                            <tr>
                                <td><pre><code><strong>sphp</strong></code></pre></td>
...
<pre><code>Usage: restartmailpit</code></pre>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading_jscripts">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapse_jscripts" aria-expanded="false"
                        aria-controls="collapse_jscripts">
                        Joomla scripts
                    </button>
                </h2>
                <div id="collapse_jscripts" class="accordion-collapse collapse"
                    aria-labelledby="heading_jscripts" data-bs-parent="#toolsAccordion">
                    <div class="accordion-body">
                        <table class="table">
                            <tr>
                                <td><pre><code><strong>jlistjoomlas</strong></code></pre></td>
...
-h Help. Display this info.</code></pre>
                            ...
                            <tr>
                                <td><pre><code><strong>joomlainfo</strong></code></pre></td>
...
<pre><code>Usage: joomlainfo</code></pre><br>
                            ...
                            <tr>
                                <td><pre><code><strong>jbackup</strong></code></pre></td>
...
-h Help. Display this info.</code></pre><br>
                            ...
                            <tr>
                                <td><pre><code><strong>jdbdump</strong></code></pre></td>
...
-h Help. Display this info.</code></pre><br>
                            ...
                            <tr>
                                <td><pre><code><strong>jdbdumpall</strong></code></pre></td>
...
-h Help. Display this info.</code></pre><br>
                                This scrips searches for all Joomla websites in the ~/Development/Sites folder and creates a database dump for each website found.<br>
                                The database dumps are stored in the ~/Development/Backup/mysql folder.
                                </td>
                            </tr>
                            <tr>
                                <td><pre><code><strong>jdbimp</strong></code></pre></td>
                                <td><strong>Import a database dump into the database of a Joomla website.</strong><br><br>
...
-h Help. Display this info.</code></pre><br>
                            ...
                            <tr>
                                <td><pre><code><strong>jdbdropall</strong></code></pre></td>
                                <td><strong>Drop all database tables of a Joomla website.</strong><br><br>
<pre><code>Usage: jdbdropall
</code></pre><br>
                                Run this command in the root of a Joomla website. The script asks your confirmation before dropping all tables.
                                </td>
                            </tr>
                            <tr>
                                <td><pre><code><strong>latestjoomla</strong></code></pre></td>
                                <td><strong>Download a zipfile of the latest Joomla! version and unzip it in the current folder.</strong><br><br>
